document.addEventListener('DOMContentLoaded', () => {
    ...
    const savedState = localStorage.getItem('automationWorkzQuizState');
    if (savedState) {
    ...
    if (resetBtn) {
        resetBtn.addEventListener('click', () => {
            ...
            localStorage.removeItem('automationWorkzQuizState');
    ...
    function evaluateQuiz(isRestore) {
        ...
        if (!isRestore) {
            ...
            localStorage.setItem('automationWorkzQuizState', JSON.stringify(state));
